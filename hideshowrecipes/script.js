...
function Search() {
    ...
    recipe-three.remove('hide')
    recipe-four.remove('hide')
    recipe-five.remove('hide')
    recipe-six.remove('hide')
    recipe-seven.remove('hide')
    recipe-eight.remove('hide')
    recipe-nine.remove('hide')
    recipe-ten.remove('hide')
    recipe-eleven.remove('hide')
    recipe-twelve.remove('hide')
}
